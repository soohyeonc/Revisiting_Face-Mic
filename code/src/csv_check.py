...
train_set = pd.read_csv("data/csvfiles/8users/8users_attack1/data_4/merged_train.csv")

test_set = pd.read_csv("data/csvfiles/8users/8users_attack1/data_4/merged_test.csv")
...
#speech
# A = train_set[train_set['ID']=='A'].head(train_number).copy()
# B = train_set[train_set['ID']=='B'].head(train_number).copy()
# C = train_set[train_set['ID']=='C'].head(train_number).copy()

#gender
# Male = train_set[train_set['ID']=='Male'].head(train_number).copy()
# Female = train_set[train_set['ID']=='Female'].head(train_number).copy()
...
#AS_F_6 = train_set[train_set['ID']=='AS_F_6'].head(train_number).copy()
...
#speech
# A_t = test_set[test_set['ID']=='A'].head(test_number).copy()
# B_t = test_set[test_set['ID']=='B'].head(test_number).copy()
# C_t = test_set[test_set['ID']=='C'].head(test_number).copy()
#gender
# Male_t = test_set[test_set['ID']=='Male'].head(test_number).copy()
# Female_t = test_set[test_set['ID']=='Female'].head(test_number).copy()
...
#AS_F_6_t = test_set[test_set['ID']=='AS_F_6'].head(test_number).copy()
...
#balanced_data = balanced_data.append([A, B, C])
#balanced_data = balanced_data.append([AS_F_1, AS_F_3, AS_F_4, AS_F_6, AS_M_1, AS_M_2, AS_M_3, AS_M_4, ME_F_1, ME_F_4, ME_F_5, ME_M_4, ME_M_7, ME_M_8])
#balanced_data = balanced_data.append([AS_F_3, AS_F_4, AS_M_3, AS_M_4, ME_F_5, ME_M_7, ME_M_8])
balanced_data = balanced_data.append([AS_F_3, AS_F_4, AS_M_3, AS_M_4, ME_F_5, ME_M_7, ME_F_6])

balanced_data_t = pd.DataFrame()
#balanced_data_t = balanced_data_t.append([A_t, B_t, C_t])
#balanced_data_t = balanced_data_t.append([AS_F_1_t, AS_F_3_t, AS_F_4_t, AS_F_6_t, AS_M_1_t, AS_M_2_t, AS_M_3_t, AS_M_4_t, ME_F_1_t, ME_F_4_t, ME_F_5_t, ME_M_4_t, ME_M_7_t, ME_M_8_t])
#balanced_data_t = balanced_data_t.append([ AS_F_3_t, AS_F_4_t, AS_M_3_t, AS_M_4_t, ME_F_5_t, ME_M_7_t, ME_M_8_t])
balanced_data_t = balanced_data_t.append([ AS_F_3_t, AS_F_4_t, AS_M_3_t, AS_M_4_t, ME_F_5_t, ME_M_7_t, ME_F_6_t])
