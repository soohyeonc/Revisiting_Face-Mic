...
#training csv#
    def training_set(c, path):
        ...
        train_number = 5695 # 1:1 # train data : test data
        reshape_number = 1134 # 1:1 # train data : test data
        framesize = 385
        ...
        balanced_data = balanced_data.append([AS_F_1, AS_F_3, AS_F_4, AS_F_6, AS_M_1, AS_M_2, AS_M_3, AS_M_4, ME_F_1, ME_F_4, ME_F_5, ME_F_6, ME_M_4, ME_M_7])
...
#testing csv#
    def testing_set(c, path):
        ...
        test_number = 1915 # 1:1 # train data : test data
        reshape_number = 378 # 1:1 # train data : test data
        framesize = 385
        ...
        balanced_data_t = balanced_data_t.append([AS_F_1_t, AS_F_3_t, AS_F_4_t, AS_F_6_t, AS_M_1_t, AS_M_2_t, AS_M_3_t, AS_M_4_t, ME_F_1_t, ME_F_4_t, ME_F_5_t, ME_F_6_t, ME_M_4_t, ME_M_7_t])
...
for i in datasetList:
    ...
    print(i +" data set")
    path ="15users/15users_target"+str(attack_number)+"/Segmentedspectrograms_" + str(count)
    csv_path = "15users/15users/data_"+ str(count) +"/merged_" #target
    ...
    path ="15users/15users_attack"+str(attack_number)+"/Segmentedspectrograms_" + str(count)
    csv_path = "15users/15users_attack"+str(attack_number)+"/data_"+ str(count) +"/merged_" #attack
