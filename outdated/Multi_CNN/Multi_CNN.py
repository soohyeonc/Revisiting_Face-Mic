...
def define_model():
  ...
  outputs = Dense(8, activation='softmax')(dense5)
...
history = model.fit([train_x, X_train, X_train_y, X_train_z], train_y,  epochs=100)#, batch_size = 64)
model.save('model.h5')
...
loss, acc = model.evaluate([train_x, X_train, X_train_y, X_train_z], train_y, verbose=0)
print('Train Accuracy: %f' % (acc*100))
print('Train Loss: %f' % (loss*100))

# evaluate model on test dataset dataset
loss, acc = model.evaluate([test_x, X_test, X_test_y, X_test_z], test_y, verbose=0)
