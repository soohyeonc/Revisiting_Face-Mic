...
#training csv#
    def training_set(c, path):
        ...
        balanced_data = balanced_data.append([AS_F_1, AS_F_3, AS_F_4, AS_F_6, AS_M_1, AS_M_2, AS_M_3, AS_M_4, ME_F_1, ME_F_4, ME_M_4, ME_M_7, ME_M_8])
...
#testing csv#
    def testing_set(c, path):
        ...
        balanced_data_t = balanced_data_t.append([AS_F_1_t, AS_F_3_t, AS_F_4_t, AS_F_6_t, AS_M_1_t, AS_M_2_t, AS_M_3_t, AS_M_4_t, ME_F_1_t, ME_F_4_t, ME_M_4_t, ME_M_7_t, ME_M_8_t])
...
def saving_result(t,loss1_1, acc1_1, loss2_1, acc2_1):
    file = open("Result/Result_attack2.txt","a")
    file.write('\n')
