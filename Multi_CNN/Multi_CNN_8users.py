...
#testing csv#
    def testing_set(c, path):
        ...
        reshape_number = 63 # 1:1 # train data : test data
        framesize = 341
...
def saving_result(t,loss1_1, acc1_1, loss2_1, acc2_1):
    ...
    file = open("Result/Result_7users.txt","a")
    file.write('\n')
...
for i in datasetList:
    ...
    print(i +" data set")
    path ="7users/Segmentedspectrograms_" + str(count)
    csv_path = "7users/data_"+ str(count) +"/merged_"
