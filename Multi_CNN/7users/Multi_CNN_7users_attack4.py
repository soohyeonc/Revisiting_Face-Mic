...
#training csv#
    def training_set(c, path):
        ...
        train_number = 1715 # 1:1 # train data : test data
        reshape_number = 162 # 1:1 # train data : test data
        framesize = 279
        ...
        balanced_data = balanced_data.append([AS_F_3, AS_F_4, AS_M_3, ME_F_5, ME_M_7, ME_M_8])
...
#testing csv#
    def testing_set(c, path):
        ...
        reshape_number = 54 # 1:1 # train data : test data
        framesize = 279
        ...
        balanced_data_t = balanced_data_t.append([AS_F_3_t, AS_F_4_t, AS_M_3_t, ME_F_5_t, ME_M_7_t, ME_M_8_t])
...
#######################################################################################################
# save attack result ##################################################################################
def attack_result(t,loss1_1, acc1_1, loss2_1, acc2_1, attack_number):
...
for i in datasetList:
    ...
    print(i +" data set")
    path ="7users_attack"+str(attack_number)+"/Segmentedspectrograms_" + str(count)
    csv_path = "7users_attack"+str(attack_number)+"/data_"+ str(count) +"/merged_" #attack
...
for i in datasetList:
    ...
    print(i +" data set")
    path ="7users_target"+str(attack_number)+"/Segmentedspectrograms_" + str(count)
    csv_path = "7users/data_"+ str(count) +"/merged_" #target
