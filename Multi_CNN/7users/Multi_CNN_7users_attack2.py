...
#training csv#
    def training_set(c, path):
        ...
        balanced_data = balanced_data.append([AS_F_3, AS_F_4, AS_M_3, AS_M_4, ME_M_7, ME_M_8])
...
#testing csv#
    def testing_set(c, path):
        ...
        balanced_data_t = balanced_data_t.append([AS_F_3_t, AS_F_4_t, AS_M_3_t, AS_M_4_t, ME_M_7_t, ME_M_8_t])
