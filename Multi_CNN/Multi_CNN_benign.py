...
#testing csv#
    def testing_set(c, path):
        ...
        reshape_number = 126 # 1:1 # train data : test data
        framesize = 352
...
def saving_result(t,loss1_1, acc1_1, loss2_1, acc2_1):
    #file = open("Result/Result_original.txt","a")
    file = open("Result/Result_benign.txt","a")
    file.write('\n')
...
for i in datasetList:
    ...
    print(i +" data set")
    path ="benign/Segmentedspectrograms_" + str(count)
    csv_path = "benign/data_"+ str(count) +"/merged_"
