...
for i in datasetList:
    ...
    print(i +" data set")
    path ="8users/8users_target"+str(attack_number)+"_temp/Segmentedspectrograms_" + str(count)
    csv_path = "8users/8users_temp/data_"+ str(count) +"/merged_" #target
    ...
    path ="8users/8users_attack"+str(attack_number)+"_temp/Segmentedspectrograms_" + str(count)
    csv_path = "8users/8users_attack"+str(attack_number)+"_temp/data_"+ str(count) +"/merged_" #attack
